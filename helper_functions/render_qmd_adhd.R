...
data_location <- "https://github.com/susannehempel-lab/adhd_management/raw/refs/heads/main/data/adhd_management_data.csv"
...
quarto::quarto_render(
  "adhd_management.qmd", output_format  = "html",
